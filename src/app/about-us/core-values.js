        ...
        <section className="flex flex-col justify-center items-center pt-15 bg-blue-50 w-full">
                <div className="flex flex-col gap-10 px-5">
                    ...
                    {corePillars.map((pillar, index) => (
                        <article key={index} className="flex items-center gap-5 p-5 text-slate-700 text-lg max-md:rounded-2xl min-md:rounded-full bg-white min-w-1/2 transition-all duration-400 hover:scale-[1.02]">
